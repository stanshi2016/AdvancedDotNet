...
{
    public class DelegateDecoupling
    {
        #region 数据准备
        /// <summary>
        /// 准备数据
        ...
        {
            Console.WriteLine($"方法2结果");
            List<Student> studentList = this.GetStudentList();
            {
                List<Student> result = this.GetList(studentList, 1);
                Console.WriteLine($"结果一共有{result.Count()}个");
            }
            {
                List<Student> result = this.GetList(studentList, 2);
                Console.WriteLine($"结果一共有{result.Count()}个");
            }
            {
                List<Student> result = this.GetList(studentList, 3);
                Console.WriteLine($"结果一共有{result.Count()}个");
            }
        }

        public void ShowMethod3()
        {
            Console.WriteLine($"方法3结果");
            List<Student> studentList = this.GetStudentList();
            {
